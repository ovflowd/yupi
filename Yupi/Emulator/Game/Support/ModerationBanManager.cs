...
namespace Yupi.Emulator.Game.Support
{
     ...
     public class ModerationBanManager
    {
     ...
     public void LoadBans(IQueryAdapter dbClient)
        {
     ...
     public string GetBanReason(string userName, string ip, string machineid)
        {
     ...
     public bool CheckIfIsBanned(string userName, string ip, string machineid)
        {
            if (_bannedUsernames.Contains(userName))
            {
                ModerationBan moderationBan = (ModerationBan)_bannedUsernames[userName];
        ...
        /// <returns>System.String.</returns>
     public string CheckMachineBan(string machineId)
        {
