     ...
     public override void OnUserSay(RoomUser user, string msg)
        {
            ...
            switch (command.CommandAction)
            {
                ...
                case "breed":
                    ...
                    if (coord == new Point())
                    {
                        SimpleServerMessageBuffer alert = new SimpleServerMessageBuffer(PacketLibraryManager.OutgoingHandler("PetBreedErrorMessageComposer"));
     ...
     public override void OnTimerTick()
        {
            ...
            if (roomUser.X == roomUser.GoalX && roomUser.Y == roomUser.GoalY && roomUser.Statusses.ContainsKey("mv") &&
                !roomUser.IsWalking)
            ...
            if (_speechTimer == 0)
            {
                ...
                if (GetRoom() != null && !GetRoom().MutedPets)
                    ...
                    roomUser.AddStatus(text, ServerUserChatTextHandler.GetString(roomUser.Z));
            }
