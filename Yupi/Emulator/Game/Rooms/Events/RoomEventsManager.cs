...
namespace Yupi.Emulator.Game.Rooms.Events
{
    ...
    /// </summary>
    internal class RoomEventsManager
    {
        /// <summary>
        ///     The Room Events
        /// </summary>
        ...
        internal Dictionary<uint, RoomEvent> GetEvents() => _events;
        ...
        internal RoomEvent GetEvent(uint roomId) => _events.ContainsKey(roomId) ? _events[roomId] : null;
        ...
        internal bool RoomHasEvents(uint roomId) => _events.ContainsKey(roomId);
