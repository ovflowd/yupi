...
{
    public class GroupForumReadThreadMessageComposer : Contracts.GroupForumReadThreadMessageComposer
    {
        public override void Compose(ISender session, int groupId, int threadId, int startIndex,
