...
{
    public class SuperNotificationMessageComposer : Contracts.SuperNotificationMessageComposer
    {
        // TODO Title default: ${generic.alert.title}
        // TODO might be that url default is "event:"
        // unknown might be icon id!
        public override void Compose(ISender session, string title, string content, string url = "", string urlName = "",
