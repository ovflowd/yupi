...
namespace Yupi.Model.Domain
{
	public class ChatBubbleStyle : Enumeration<ChatBubbleStyle>
	{
		...
		public static readonly ChatBubbleStyle Staff = new ChatBubbleStyle (23, "Staff", (x) => x.HasPermission("staff_chat_bubble"));
		...
		protected ChatBubbleStyle (int value, string displayName, Func<UserInfo, bool> canUse = null) : base (value, displayName)
		{
