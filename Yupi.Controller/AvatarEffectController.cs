...
namespace Yupi.Controller
{
    public class AvatarEffectController
    {
        ...
        public void ActivateEffect(UserEntity user, int effectId)
        {
            ...
            var avatarEffect = user.UserInfo.EffectComponent.Effects.Last(x => x.EffectId == effectId);
        ...
        public void CheckExpired(Habbo user)
        {
            ...
            foreach (var effect in expiredEffects) StopEffect(user, effect);
        }
        ...
        {
            var userRoom = entity.Room;

            if (setAsCurrentEffect) entity.UserInfo.EffectComponent.ActiveEffect = effect;
